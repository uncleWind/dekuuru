...
urlpatterns = [
    ...
    url(r'^board/(?P<boardTag>[a-zA-Z]+)/admin/', 'dekuuro.views.boardAdminView', name='boardAdmin'),
    url(r'^board/(?P<boardTag>[a-zA-Z]+)/members/', 'dekuuro.views.boardMembersView', name='boardMembers'),
